...
const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    date: "2025-02-10",
    type: "medication",
    title: "Metformin Dosage Adjustment",
    description: "Increased from 500mg to 750mg twice daily",
    status: "completed",
    provider: "Dr. Smith",
    reasoning:
      "HbA1c levels remained elevated at 8.2%. Patient showed good tolerance to current dose with no GI side effects.",
  },
  {
    id: "2",
    date: "2025-02-05",
  ...
  },
  {
    ...
    description: "Routine diabetes management review",
    status: "completed",
    provider: "Dr. Smith",
    outcome: "Medication adjustment recommended",
  },
  {
    id: "4",
    date: "2025-03-15",
    type: "milestone",
    title: "3-Month Treatment Milestone",
    description: "Completed initial treatment phase",
    status: "pending",
    outcome: "Partial improvement in glucose control",
  },
  {
    id: "5",
    date: "2025-03-10",
    ...
    description: "Review medication adjustment effects",
    status: "pending",
    provider: "Dr. Smith",
  },
  {
